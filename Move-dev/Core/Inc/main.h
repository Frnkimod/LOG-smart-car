...
#define RU_DIR_GPIO_Port GPIOB
#define TT_STP_Pin GPIO_PIN_8
#define TT_STP_GPIO_Port GPIOB
#define TT_DIR_Pin GPIO_PIN_9
#define TT_DIR_GPIO_Port GPIOB
